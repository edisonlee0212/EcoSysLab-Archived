...
for x in range(0, numberPerSpecie):
	target_descriptor_path = "C:\\Users\\lllll\\Documents\\GitHub\\EcoSysLab\\Resources\\EcoSysLabProject\\TreeDescriptors\\Ash.td"
	name = "Ash_" + str(index)
	target_tree_mesh_path = output_root + name + ".obj"
	target_tree_pointcloud_path = output_root + name + ".ply"
	target_tree_junction_path = output_root + name + ".yml"
...
for x in range(0, numberPerSpecie):
	target_descriptor_path = "C:\\Users\\lllll\\Documents\\GitHub\\EcoSysLab\\Resources\\EcoSysLabProject\\TreeDescriptors\\Apple.td"
	name = "Apple_" + str(index)
	target_tree_mesh_path = output_root + name + ".obj"
	target_tree_pointcloud_path = output_root + name + ".ply"
	target_tree_junction_path = output_root + name + ".yml"
	pesl.generate_tree_point_cloud(pcps, pccs, target_descriptor_path, 0.08220, 999, 20000, tmgs, target_tree_pointcloud_path, False, target_tree_mesh_path, False, target_tree_junction_path)
...
for x in range(0, numberPerSpecie):
	target_descriptor_path = "C:\\Users\\lllll\\Documents\\GitHub\\EcoSysLab\\Resources\\EcoSysLabProject\\TreeDescriptors\\Acacia.td"
	name = "Acacia_" + str(index)
	target_tree_mesh_path = output_root + name + ".obj"
	target_tree_pointcloud_path = output_root + name + ".ply"
	target_tree_junction_path = output_root + name + ".yml"
	pesl.generate_tree_point_cloud(pcps, pccs, target_descriptor_path, 0.08220, 999, 20000, tmgs, target_tree_pointcloud_path, False, target_tree_mesh_path, False, target_tree_junction_path)
...
for x in range(0, numberPerSpecie):
	target_descriptor_path = "C:\\Users\\lllll\\Documents\\GitHub\\EcoSysLab\\Resources\\EcoSysLabProject\\TreeDescriptors\\Spruce.td"
	name = "Spruce_" + str(index)
	target_tree_mesh_path = output_root + name + ".obj"
	target_tree_pointcloud_path = output_root + name + ".ply"
	target_tree_junction_path = output_root + name + ".yml"
	pesl.generate_tree_point_cloud(pcps, pccs, target_descriptor_path, 0.08220, 999, 20000, tmgs, target_tree_pointcloud_path, False, target_tree_mesh_path, False, target_tree_junction_path)
...
for x in range(0, numberPerSpecie):
	target_descriptor_path = "C:\\Users\\lllll\\Documents\\GitHub\\EcoSysLab\\Resources\\EcoSysLabProject\\TreeDescriptors\\Willow.td"
	name = "Willow_" + str(index)
	target_tree_mesh_path = output_root + name + ".obj"
	target_tree_pointcloud_path = output_root + name + ".ply"
	target_tree_junction_path = output_root + name + ".yml"
	pesl.generate_tree_point_cloud(pcps, pccs, target_descriptor_path, 0.08220, 999, 20000, tmgs, target_tree_pointcloud_path, False, target_tree_mesh_path, False, target_tree_junction_path)
...
for x in range(0, numberPerSpecie):
	target_descriptor_path = "C:\\Users\\lllll\\Documents\\GitHub\\EcoSysLab\\Resources\\EcoSysLabProject\\TreeDescriptors\\Hazel.td"
	name = "Hazel_" + str(index)
	target_tree_mesh_path = output_root + name + ".obj"
	target_tree_pointcloud_path = output_root + name + ".ply"
	target_tree_junction_path = output_root + name + ".yml"
	pesl.generate_tree_point_cloud(pcps, pccs, target_descriptor_path, 0.08220, 999, 20000, tmgs, target_tree_pointcloud_path, False, target_tree_mesh_path, False, target_tree_junction_path)
