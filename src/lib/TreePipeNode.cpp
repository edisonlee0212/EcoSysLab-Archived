...
void TreePipeNode::Merge(const PipeModelParameters& pipeModelParameters, const bool scheduling)
{
	if (scheduling) {
...
void TreePipeNode::Pack(const PipeModelParameters& pipeModelParameters, const bool scheduling)
{
	Wait();
