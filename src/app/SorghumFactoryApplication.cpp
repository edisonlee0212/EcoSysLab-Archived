...
int main() {
	...
	applicationConfigs.m_applicationName = "SorghumFactory";
	applicationConfigs.m_projectPath = std::filesystem::absolute(resourceFolderPath / "SorghumProject" / "test.eveproj");
