...
namespace EcoSysLab {
	...
	public:
		...
		void ChangeWater(   const glm::vec3& center, float amount_in_g, float width); // distributes the given amount of grams of water in the area around the center
	...
	protected:
		...
		[[nodiscard]] float IntegrateFieldValue(const Field& field, const glm::vec3& center, float width) const; // returns the cm3 of a certain quantity within the width in the field
