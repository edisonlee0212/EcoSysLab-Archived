...
#pragma endregion
        ...
        static void TriangulateField(const std::function<float(const glm::vec3 &samplePoint)>& sampleFunction, float isovalue, float cellRadius, const std::vector<glm::vec3>& testingCells, 
